...
public class TestSystemtesting {
	...
	public void viewalll() throws Throwable {
		...
		driver.findElement(By.xpath(
				"/html/body/div[1]/div/div/div/div[2]/div/div/div[4]/div[1]/div/div/div[1]/div[2]/button/span[1]")).click();
	}
	...
	public void Input() throws Throwable {
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("KEN4201");
	}
...
//	}
	...
	@Test(priority = 30)
	public void QuestionPaper() throws Throwable {
		Thread.sleep(2000);
	...
	@Test(priority = 31)
	public void dropdown9() throws Throwable {
		Thread.sleep(2000);

		driver.findElement(By.xpath("/html/body/div[1]/div/div/div/div[2]/div/div/header/div/div/button/span[1]"))
				.click();
	}

	@Test(priority = 32)
	public void dropdown10() throws Throwable {
		Thread.sleep(2000);
	...
	@Test(priority = 33)
	public void dropdownrecord() throws Throwable {
		Thread.sleep(2000);

		driver.findElement(By.xpath("//li[.='BEC Term 6 Master']")).click();
	}

	@Test(priority = 34)
	public void dropdown11() throws Throwable {
		Thread.sleep(2000);
	...
	@Test(priority = 35)
	public void dropdownrecord1() throws Throwable {
		Thread.sleep(2000);

		driver.findElement(By.xpath("//li[.='BECCPP301-Capstone Project']")).click();
	}

	@Test(priority = 36)
	public void dropdown12() throws Throwable {
		Thread.sleep(2000);
	...
	@Test(priority = 37)
	public void Submitted() throws Throwable {
		Thread.sleep(2000);

		driver.findElement(By.xpath("//li[.='Submitted']")).click();
	}

	@Test(priority = 38)
	public void dropdown13() throws Throwable {
		Thread.sleep(2000);
	...
	@Test(priority = 40)
	public void Questionpapertab() throws Throwable {
		Thread.sleep(2000);
	...
	public void view1() throws Throwable {
		...
		driver.findElement(By.xpath("(//span[.='View'])[6]")).click();
	}
